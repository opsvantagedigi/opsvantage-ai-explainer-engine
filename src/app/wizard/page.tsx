    ...
    <div className="bg-gray-900 text-white min-h-screen flex flex-col items-center justify-center font-sans">
      ...
      <main className="text-center">
        <div className="glass-box">
            <h2 className="text-4xl font-bold mb-4 font-orbitron bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-green-500">Video Creation Wizard</h2>
            <p className="text-lg">
              This wizard will guide you through the process of creating a new YouTube video.
            </p>
        </div>
      </main>

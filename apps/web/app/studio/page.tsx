    ...
    <div className="h-screen grid grid-rows-[auto_1fr] overflow-hidden">
      ...
      <header className="px-6 py-4 flex justify-between items-center border-b border-white/10 bg-black/40 backdrop-blur-xl">
        <div className="flex items-center gap-4">
          <h1 className="heading-orbitron text-2xl md:text-3xl font-black brand-text-gradient">
            AI-YouTube Studio
          </h1>
        ...
        <button className="px-6 py-2 bg-white text-black font-bold rounded-full text-sm hover:bg-yellow-400 transition-colors spring-pop">
          EXPORT VIDEO
        </button>
      </header>
          ...
          <div className="glass-panel aspect-video relative overflow-hidden group shrink-0">
            ...
            <div className="absolute bottom-0 w-full p-4 bg-black/60 backdrop-blur-md flex justify-between items-center">
              <div className="flex gap-4 items-center">
                <div
                  className={`w-3 h-3 rounded-full ${playing ? 'bg-red-500 animate-ping' : 'bg-white/40'}`}
                />
